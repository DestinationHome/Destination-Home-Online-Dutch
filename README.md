# <h1 align="center">**Destination Home Online × Welkom terug bij PlayStation®Home! | WIP**</h1>
...
- Om deze README pagina in andere talen te bekijken, zijn hier de volgende ondersteunde talen die vertaald zijn door ons buitengewone contribuanten/moderatie team:
   
  - [Dutch](https://github.com/DestinationHome/Destination-Home-Online-Dutch)  | SSpeciale dank aan Tymek for voor het bijdragen van deze vertaling.
  - [Frans](https://github.com/DestinationHome/Destination-Home-Online-French)  | Speciale dank aan [Marion](https://twitter.com/Marion4GF) & [TreezZ#8905](https://discordapp.com/users/605516950054895633) oor het bijdragen van deze vertaling.
   - [Italiaans](https://github.com/DestinationHome/Destination-Home-Online-Italy)  | Speciale dank aan [Sidereus](https://twitter.com/__Sidereus__) for voor het bijdragen van deze vertaling.
   - [Japans](https://github.com/DestinationHome/Destination-Home-Online-Japan)  | Speciale dank aan [piyo](https://twitter.com/piyopiy80151704) voor het bijdragen van deze vertaling.
...
Welkom bij de officiële gids over hoe gebruikers [PlayStation®Home](https://en.wikipedia.org/wiki/PlayStation_Home) online opnieuw kunnen ervaren op de originele PS3 en [RPCS3](https://rpcs3.net/). Volg onze Discussions-pagina op onze [Github](https://github.com/DestinationHome/Destination-Home-Online/discussions) om op de hoogte te blijven van het project. Hier zal onze Community Manager [**Figment**](https://github.com/PSHFigment) het laatste nieuws met betrekking tot nieuwe Home-updates posten. Voor alles wat met PlayStation®Home te maken heeft, hebben we een uitgebreid configuratie [wiki-systeem](https://github.com/DestinationHome/Destination-Home-Online/wiki) voor deze repo gemaakt, om te documenteren hoe gebruikers toegang kunnen krijgen tot onze services.  
...
# <h1 align="center">🌐 Destination Home Openbare DNS Instelling: *Wordt binnenkort aangekondigd.*</h1>
...
<h1 align="center">📖 Inhoudsopgave | Destination Home Online Wiki 📖</h1>
...
Om dit README.md-bestand overzichtelijk en eenvoudig te houden, heb ik besloten om een officiële [wiki](https://github.com/DestinationHome/Destination-Home-Online/wiki) te maken met een volledig overzicht van hoe gebruikers online toegang kunnen krijgen tot PlayStation®Home met onze aangepaste server oplossing. Om onze laatste online client builds te downloaden, kun je [hier](https://github.com/DestinationHome/Destination-Home-Online/releases) de release pagina bekijken. Hieronder vind je de minimale vereisten die je nodig hebt voor dit proces.  
  

| Vereisten Voor PS3: | Vereisten Voor RPCS3: |
| ------------- | ------------- |
| Een [PlayStation 3](https://en.wikipedia.org/wiki/PlayStation_3). | Een PC die de [recommended hardware requirements](https://rpcs3.net/quickstart) voor het uitvoeren van de emulator ondersteunt.  |
| Een [PlayStation™Network Account](https://www.playstation.com/en-us/playstation-network/). | [RPCN Account](https://wiki.rpcs3.net/index.php?title=Help:Netplay). |
...
- [x] Gebruikers met PlayStation®Plus op PSN krijgen toegang tot extra lettertype kleuren voor hun ID's in-game en kunnen het haar van hun avatar in elke gewenste kleur aanpassen. Voor meer informatie over deze functie kun je de video hieronder bekijken.

https://user-images.githubusercontent.com/67494727/168451055-be2e97d4-d0c6-4596-afbe-388c5d9e10c9.mp4

# Ontbrekende diensten/functies:
...
- Zoals altijd bij grote softwareprojecten, kunnen zelfs de beste applicaties bugs bevatten, en PlayStation Home online vormt hierop geen uitzondering. Dit gezegd hebbende, besteedt Destination Home veel aandacht aan de stabiliteit voor onze community. Als je kritieke bugs ziet, maak dan alsjeblieft een ticket/issue aan, [hier](https://github.com/DestinationHome/Destination-Home-Online/issues) op de officiële Destination Home Online repo. Om bugs snel te kunnen verhelpen, vragen we gebruikers om zoveel mogelijk documentatie aan te leveren. Bijvoorbeeld:  

  - Welke client gebruik je (RPCS3/PS3)?
  - Waar deed deze bug zich voor? Geef de naam van de scène door.
  - Voeg foto's/video's bij van de fout.
  
- Als je een onderwerp ziet dat al **gedocumenteerd** is, maak dan alstublieft niet nog een rapport/thread aan, omdat dit verwarring zal veroorzaken voor het ontwikkelingsteam.  
...
Heb je vragen over deze release? Voel je vrij om contact met mij op te nemen via onderstaande socials:
  ...
  <p align="center">
   ...
   <a href="https://discordapp.com/users/975698824196657182">
        <img src="https://img.shields.io/badge/Mijn%20Discord-Nagato%230938-5865F2"
            alt="Official Nagato Discord ID"></a>
    <a href="https://www.youtube.com/channel/UCXgz1g5ET8Un9gax-nGMjMw">
        <img src="https://img.shields.io/badge/Mijn%20YouTube%20Kanaal-Nagato's%20Revenge-ff0000"
            alt="Official Nagato Revenge YouTube Channel"></a>

# ❤️ Word lid van/bekijk onze sociale platforms:
...
<p align="center">
  ...
  <a href="http://destinationho.me/">
     <img src="https://img.shields.io/badge/-Destination%20Home%20Officiële%20Website-0995d3"        
         alt="Destination Home Online Official Website"></a>
  <a href="https://www.twitch.tv/playstationhome/videos">
    <img src="https://img.shields.io/badge/Volg%20ons%20op-Twitch-8048fa"
         alt="Follow us on Twitch"></a>
  <a href="https://www.youtube.com/channel/UCQhwhFevEgsRqMTHof7FwPQ">
      <img src="https://img.shields.io/badge/Volg%20ons%20op-YouTube-ff0000"
            alt="Follow us on YouTube"></a>
...
- Dank aan de Destination Home/PlayStation Home gemeenschap voor het doneren van de hoognodige data! Zonder jullie zou dit preservatieproject niet online zijn, noch gearchiveerd voor educatieve doeleinden.
...
Bedankt Sony/PlayStation voor het creëren van deze adembenemende sociale wereld!Wij zijn niet verbonden met Sony Interactive Entertainment (SIE) of andere spelontwikkelaars met een licentie van SIE. Dit project is puur voor preservatie/educatieve doeleinden, en ons team accepteert geen enkele vorm van donaties.

**Alle rechten zijn voorbehouden aan Sony Interactive Entertainment Europe Limited en aan de respectieve derde bedrijven die verantwoordelijk zijn voor het implementeren van de inhoud in PlayStation®Home. Destination Home werkt aan PlayStation®Home als de aanpassing van openbaar uitgelekte software, waarbij het gebruik van deze software onder abandonware valt vanwege het gebrek aan handhaving van het auteursrecht op de tools. Het online gedeelte van PlayStation®Home wordt beschermd door de wetten die voortvloeien uit de Digital Millennium Copyright Act 17 U.S. Code § 1201 met het oog op bewaring, educatie en publieke vertoning als een museum inspanning. Het team zich richt op het reproduceren van de functionaliteit die ooit toegankelijk was en werd gehost door Sony, PlayStation®Home. Hulpmiddelen die ons ter beschikking worden gesteld zullen naar ons beste vermogen worden voorzien van de grootst mogelijke bescherming, tenzij anders aangegeven door de aanbieder. Onze focus ligt op de bescherming van Sony's auteursrecht en intellectuele eigendom terwijl we het doel van reproductie van online functionaliteit volgen, en we claimen niets van dit alles als ons eigendom.**
